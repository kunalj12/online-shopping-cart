...
public class AddProducts extends HttpServlet {
    ...
    private final String UPLOAD_DIRECTORY = "D:\\ccee\\OnlineShoppingSystem\\src\\main\\webapp\\images";
            ...
            try {
                ...
                for (FileItem item : multiparts) {
                    if (!item.isFormField()) {
                        ...
                        item.write(new File("D:\\ccee\\OnlineShoppingSystem\\src\\main\\webapp\\images" + File.separator + imageName));
                ...
                try {
                    int id = 0;
                    String imagePath = "D:\\ccee\\OnlineShoppingSystem\\src\\main\\webapp\\images" + imageName;
