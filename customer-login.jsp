                ...
                <div class="modal-body modal-spa">
                    <div class="login-grids">
						...
						<button class="btn btn-success" data-toggle="modal"
								data-target="#forgotpassword">forgot Password ?</button></center>
												...
												<div class="card-body">
													<form action="SendMailServlet" method="get">
														<div class="form-group">
															<label for="">Enter email id</label> <input
																type="email" name="femail" required id=""
																class="form-control">
																<input type="hidden" name="role" value="admin"/>
																 <br>
															<button class="btn btn-success">Send details</button>
														</div>
													</form>
												</div>
											</div>
